...
As of now , I have submitted my readMe file, code.gs file and built-in functions.pdf file for those working files.
But, since I am not able to upload it here(this shared with me folder) so, I have recreated those google forms and spreadsheet but without trigger in my app script code and also added them in the folder.
It is my humble to you to please add trigger and change the 'event type' to 'On form submit' before using it.

After adding trigger, it works same as I created it actually and now you can view and follow the readMe_11940160 to check furthur working of my app.
